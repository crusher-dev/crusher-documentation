...
1.) T3.large instance ~= 60.81$
 - These are burstable instance, if your usage are high go with c3.large $73.

 - If you reserve instance for 1 year, 36$/month

2.) 45gb EBS storage ~= 3.6$

65$/month can run 1 parallel test. Which is way cheaper than any other testing solution out there.
