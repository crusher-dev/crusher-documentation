...
export function Header({ navIsOpen, onNavToggle }) {
  return (
    <>
      ...
      <div style={{background: '#0a0c0e' || '#584fe0', position: 'fixed', width: '100%', zIndex: 100}}>
      <div className="sticky top-0 z-40 lg:z-50 w-full mx-auto flex-none flex">
        <div className="flex-none pl-4 sm:pl-6 xl:pl-8 flex items-center border-b text-gray-500 lg:border-b-0 lg:w-60 xl:w-72 z-50
        ">
          <Link href="/">
            <a
            ...
            >
              <span className="sr-only">Crusher home page</span>
              <Logo className="w-auto h-6" />
            </a>
          </Link>
        </div>
        <div className="flex-auto h-16 flex items-center justify-between px-4 sm:px-6 lg:mx-6 lg:px-0 xl:mx-8">
          <Search />
