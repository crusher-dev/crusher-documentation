  ...
  return (
    <ul className="grid sm:grid-cols-1 gap-6 xl:gap-8 ">
      <li>
        ...
        >
          <svg fill="currentColor" className="flex-none text-gray-100 w-12 h-12">
      ...
      {/* <li>
        <a href="/discord" className="flex items-start space-x-4">
          ...
          <div className="flex-auto">
            <h3 className="font-bold text-gray-100">Discord</h3>
            <p>Join our Discord group to chat with other Crusher users.</p>
          </div>
        </a>
      </li> */}
      {/* <li>
        <a href="https://twitter.com/tailwindcss" className="flex items-start space-x-4">
          ...
          <div className="flex-auto">
            <h3 className="font-bold text-gray-100">Twitter</h3>
            <p>Follow the Crusher account for product updates.</p>
          </div>
        </a>
      </li> */}
